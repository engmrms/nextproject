...
const CommingSoon = () => {
  ...
  return (
    <div className="h-full before:fixed before:top-0 before:left-0 before:h-full before:w-full before:opacity-70 before:z-10 before:bg-[#2a5555]">
      <div className="lg:min-h-full flex flex-col lg:flex-row overflow-hidden">
        <video
      ...
      ">
          <div className=" relative w-[50rem] lg:pl-8 lg:pr-36  py-20 lg:py-0 text-white">
            <div className="px-8 px-lg-0">
              <h1 className="italic lg:text-4.6 text-3.2  mb-16">Our Website is Coming Soon</h1>
              <p className="mb-12 ">
        ...
        <div className="relative  z-10 lg:absolute lg:h-full lg:top-0 lg:right-10 lg:w-auto">
          <div className="flex flex-row lg:flex-col justify-center items-center h-full mt-3 lg:mt-0">
            <a
              ...
              target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" className="h-6 w-6" viewBox="0 0 496 512">
            ...
            <a
              ...
              target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" className="h-6 w-6" viewBox="0 0 448 512">
            ...
            <a
              ...
              target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" className="h-6 w-6" viewBox="0 0 512 512">
